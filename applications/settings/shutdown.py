...
Provides a confirmation dialog to shut down the badge system.
"""
...
class ShutdownApp(app.App):
    ...
    def do_shutdown(self):
        # Notify user (visual only since we are about to power off)
        msg = lv.label(self.screen)
        msg.set_text("Shutting down...")
        msg.center()
